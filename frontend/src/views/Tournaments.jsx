        ...
        <div className="relative z-10">
          ...
          <div className="pt-32 px-6 pb-12">
            ...
            {loading ? (
              ...
              >
                <div className="inline-block animate-spin rounded-full h-16 w-16 border-4 border-green border-t-transparent"></div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {tournaments.map((t, idx) => (
                  <motion.div
                    ...
                    className="relative p-6 bg-white/90 backdrop-blur-md rounded-3xl shadow-xl border border-green-100 hover:shadow-2xl hover:border-green-200 transition-all duration-200 overflow-hidden group cursor-pointer"
                    whileHover={{ y: -8, scale: 1.02, transition: { duration: 0.2 } }}
                    onClick={() => navigate(`/tournaments/${t.id}`)}
                  >
                    {/* Decorative elements with larger hover motion */}
                    <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-green/20 to-transparent rounded-bl-full transform-gpu transition-transform duration-700 ease-out group-hover:scale-125 group-hover:rotate-[15deg] group-hover:translate-x-3 group-hover:-translate-y-2" />
                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-light-green/30 to-transparent rounded-tr-full transform-gpu transition-transform duration-700 ease-out group-hover:scale-125 group-hover:-rotate-[15deg] group-hover:-translate-x-3 group-hover:translate-y-2" />
                    ...
                    <div className="relative">
                      ...
                      <div className="flex flex-wrap gap-3 mb-4">
                        <div className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-dark-green">
