            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="md:col-span-2 bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-green-100 p-8"
                >
                  {isEditing ? (
                    /* Edit form */
                ...
                <motion.div
                  ...
                  className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-green-100 p-6"
                >
