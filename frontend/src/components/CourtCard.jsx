function CourtCard({ court }) {
    return (
        <div className="bg-white rounded-[24px] w-3xs border border-gray-200 p-[23px] h-[380px] z-10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:border-green group cursor-pointer">
